...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflaterFactory {
  ...
  private ViewGroup createSubDecor() {
    ...
    TypedArray typedArray = this.mContext.obtainStyledAttributes(R.styleable.Theme);
    if (!typedArray.hasValue(R.styleable.Theme_windowActionBar)) {
      typedArray.recycle();
      throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
    } 
    if (typedArray.getBoolean(R.styleable.Theme_windowNoTitle, false)) {
      requestWindowFeature(1);
    } else if (typedArray.getBoolean(R.styleable.Theme_windowActionBar, false)) {
      requestWindowFeature(108);
    } 
    if (typedArray.getBoolean(R.styleable.Theme_windowActionBarOverlay, false))
      requestWindowFeature(109); 
    if (typedArray.getBoolean(R.styleable.Theme_windowActionModeOverlay, false))
      requestWindowFeature(10); 
    this.mIsFloating = typedArray.getBoolean(R.styleable.Theme_android_windowIsFloating, false);
    typedArray.recycle();
      ...
      if (Build.VERSION.SDK_INT >= 21) {
        ...
        ((FitWindowsViewGroup)viewGroup1).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener() {
              public void onFitSystemWindows(Rect param1Rect) {
                param1Rect.top = AppCompatDelegateImplV7.this.updateStatusGuard(param1Rect.top);
              }
            });
      } 
    } 
  ...
  private PanelFeatureState getPanelState(int paramInt, boolean paramBoolean) {
    // Byte code:
    //   0: aload_0
    //   1: getfield mPanels : [Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
    //   4: astore #4
    //   6: aload #4
    //   8: ifnull -> 21
    //   11: aload #4
    ...
    //   22: iconst_1
    //   23: iadd
    //   24: anewarray android/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState
    //   27: astore #5
    //   29: aload #4
    //   31: ifnull -> 46
    //   34: aload #4
    ...
    //   49: aload_0
    //   50: aload #5
    //   52: putfield mPanels : [Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;
    //   55: aload_3
    //   56: iload_1
    //   57: aaload
    //   58: astore #5
    ...
    //   64: aload #5
    //   66: ifnonnull -> 84
    //   69: new android/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState
    //   72: dup
    //   73: iload_1
  ...
  private void openPanel(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent) {
    ...
    //   103: aload_1
    //   104: iconst_1
    //   105: invokespecial closePanel : (Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Z)V
    //   108: return
    //   109: iconst_0
    //   110: istore_3
    //   111: goto -> 48
    ...
    //   141: aload_1
    //   142: aload_2
    //   143: invokespecial preparePanel : (Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/KeyEvent;)Z
    //   146: ifeq -> 14
    //   149: bipush #-2
    //   151: istore #4
    //   153: aload_1
    ...
    //   174: aload_0
    //   175: aload_1
    //   176: invokespecial initializePanelDecor : (Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    //   179: ifeq -> 14
    //   182: aload_1
    ...
    //   189: aload_0
    //   190: aload_1
    //   191: invokespecial initializePanelContent : (Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    //   194: ifeq -> 14
    //   197: aload_1
  ...
  private boolean performPanelShortcut(PanelFeatureState paramPanelFeatureState, int paramInt1, KeyEvent paramKeyEvent, int paramInt2) {
    ...
    //   28: aload_1
    //   29: aload_3
    //   30: invokespecial preparePanel : (Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/KeyEvent;)Z
    //   33: ifeq -> 60
    //   36: iload #6
    //   38: istore #5
    //   40: aload_1
    ...
    //   92: aload_1
    //   93: iconst_1
    //   94: invokespecial closePanel : (Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Z)V
    //   97: iload #5
    //   99: ireturn
  }
  ...
  private boolean shouldInheritContext(ViewParent paramViewParent) {
    ViewParent viewParent = paramViewParent;
  ...
  public View createView(View paramView, String paramString, @NonNull Context paramContext, @NonNull AttributeSet paramAttributeSet) {
    ...
    if (bool1 && this.mSubDecorInstalled && shouldInheritContext((ViewParent)paramView)) {
      boolean bool = true;
      return this.mAppCompatViewInflater.createView(paramView, paramString, paramContext, paramAttributeSet, bool, bool1, true);
    } 
    boolean bool2 = false;
  ...
  public void setSupportActionBar(Toolbar paramToolbar) {
    ...
    ToolbarActionBar toolbarActionBar = new ToolbarActionBar(paramToolbar, ((Activity)this.mContext).getTitle(), this.mAppCompatWindowCallback);
  ...
  ActionMode startSupportActionModeFromWindow(ActionMode.Callback paramCallback) {
    ...
    if (this.mActionMode != null)
      this.mActionMode.finish(); 
    ActionModeCallbackWrapperV7 actionModeCallbackWrapperV7 = new ActionModeCallbackWrapperV7(paramCallback);
    ActionMode actionMode2 = null;
    ActionMode actionMode1 = actionMode2;
    if (this.mAppCompatCallback != null) {
      actionMode1 = actionMode2;
      if (!isDestroyed())
        try {
          actionMode1 = this.mAppCompatCallback.onWindowStartingSupportActionMode(actionModeCallbackWrapperV7);
    ...
    if (actionMode1 != null) {
        ...
        if (this.mIsFloating) {
          ...
          this.mShowActionModePopup = new Runnable() {
              public void run() {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener((ViewPropertyAnimatorListener)new ViewPropertyAnimatorListenerAdapter() {
      ...
      if (this.mActionModeView != null) {
        ...
        StandaloneActionMode standaloneActionMode = new StandaloneActionMode(context, actionBarContextView, actionModeCallbackWrapperV7, bool);
  ...
  private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
    ...
    public void onCloseMenu(MenuBuilder param1MenuBuilder, boolean param1Boolean) {
      AppCompatDelegateImplV7.this.checkCloseActionMenu(param1MenuBuilder);
    }
  ...
  class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
    ...
    public ActionModeCallbackWrapperV7(ActionMode.Callback param1Callback) {
  ...
  private class ListMenuDecorView extends ContentFrameLayout {
    ...
    public boolean dispatchKeyEvent(KeyEvent param1KeyEvent) {
      return (AppCompatDelegateImplV7.this.dispatchKeyEvent(param1KeyEvent) || super.dispatchKeyEvent(param1KeyEvent));
    }
    ...
    public void setBackgroundResource(int param1Int) {
      setBackgroundDrawable(TintManager.getDrawable(getContext(), param1Int));
    }
  }
  ...
  private static final class PanelFeatureState {
    ...
    void setStyle(Context param1Context) {
      ...
      TypedArray typedArray = contextThemeWrapper.obtainStyledAttributes(R.styleable.Theme);
      this.background = typedArray.getResourceId(R.styleable.Theme_panelBackground, 0);
      this.windowAnimations = typedArray.getResourceId(R.styleable.Theme_android_windowAnimationStyle, 0);
      typedArray.recycle();
    }
    
    private static class SavedState implements Parcelable {
      public static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() {
            public AppCompatDelegateImplV7.PanelFeatureState.SavedState createFromParcel(Parcel param3Parcel, ClassLoader param3ClassLoader) {
              return AppCompatDelegateImplV7.PanelFeatureState.SavedState.readFromParcel(param3Parcel, param3ClassLoader);
            }
            
            public AppCompatDelegateImplV7.PanelFeatureState.SavedState[] newArray(int param3Int) {
              return new AppCompatDelegateImplV7.PanelFeatureState.SavedState[param3Int];
            }
          });
      ...
      private static SavedState readFromParcel(Parcel param2Parcel, ClassLoader param2ClassLoader) {
        boolean bool = true;
        SavedState savedState = new SavedState();
    ...
    static final class null implements ParcelableCompatCreatorCallbacks<SavedState> {
      public AppCompatDelegateImplV7.PanelFeatureState.SavedState createFromParcel(Parcel param2Parcel, ClassLoader param2ClassLoader) {
        return AppCompatDelegateImplV7.PanelFeatureState.SavedState.readFromParcel(param2Parcel, param2ClassLoader);
      }
      
      public AppCompatDelegateImplV7.PanelFeatureState.SavedState[] newArray(int param2Int) {
        return new AppCompatDelegateImplV7.PanelFeatureState.SavedState[param2Int];
      }
    }
  }
  ...
  private static class SavedState implements Parcelable {
    ...
    private static SavedState readFromParcel(Parcel param1Parcel, ClassLoader param1ClassLoader) {
      boolean bool = true;
      SavedState savedState = new SavedState();
  ...
  static final class null implements ParcelableCompatCreatorCallbacks<PanelFeatureState.SavedState> {
    public AppCompatDelegateImplV7.PanelFeatureState.SavedState createFromParcel(Parcel param1Parcel, ClassLoader param1ClassLoader) {
      return AppCompatDelegateImplV7.PanelFeatureState.SavedState.readFromParcel(param1Parcel, param1ClassLoader);
    }
    
    public AppCompatDelegateImplV7.PanelFeatureState.SavedState[] newArray(int param1Int) {
      return new AppCompatDelegateImplV7.PanelFeatureState.SavedState[param1Int];
    }
  }
  ...
  private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
    ...
    public void onCloseMenu(MenuBuilder param1MenuBuilder, boolean param1Boolean) {
      ...
      AppCompatDelegateImplV7.PanelFeatureState panelFeatureState = appCompatDelegateImplV7.findMenuPanel((Menu)param1MenuBuilder);
      if (panelFeatureState != null) {
        if (bool) {
          AppCompatDelegateImplV7.this.callOnPanelClosed(panelFeatureState.featureId, panelFeatureState, (Menu)menuBuilder);
          AppCompatDelegateImplV7.this.closePanel(panelFeatureState, true);
          return;
        } 
      } else {
        return;
      } 
      AppCompatDelegateImplV7.this.closePanel(panelFeatureState, param1Boolean);
    }
    
    public boolean onOpenSubMenu(MenuBuilder param1MenuBuilder) {
      if (param1MenuBuilder == null && AppCompatDelegateImplV7.this.mHasActionBar) {
        Window.Callback callback = AppCompatDelegateImplV7.this.getWindowCallback();
        if (callback != null && !AppCompatDelegateImplV7.this.isDestroyed())
          callback.onMenuOpened(108, (Menu)param1MenuBuilder); 
      } 
      return true;
    }
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v7\app\AppCompatDelegateImplV7.class
