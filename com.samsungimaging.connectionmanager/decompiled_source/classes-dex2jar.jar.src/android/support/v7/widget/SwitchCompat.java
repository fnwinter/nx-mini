...
public class SwitchCompat extends CompoundButton {
    ...
    this.mPositionAnimator.setAnimationListener(new Animation.AnimationListener() {
          public void onAnimationEnd(Animation param1Animation) {
            if (SwitchCompat.this.mPositionAnimator == param1Animation) {
              ...
              SwitchCompat.access$102(SwitchCompat.this, (SwitchCompat.ThumbAnimation)null);
            } 
          }
  ...
  public void setSwitchTextAppearance(Context paramContext, int paramInt) {
    ...
    ColorStateList colorStateList = typedArray.getColorStateList(R.styleable.TextAppearance_android_textColor);
    if (colorStateList != null) {
      this.mTextColors = colorStateList;
    } else {
      this.mTextColors = getTextColors();
    } 
    paramInt = typedArray.getDimensionPixelSize(R.styleable.TextAppearance_android_textSize, 0);
    if (paramInt != 0 && paramInt != this.mTextPaint.getTextSize()) {
      this.mTextPaint.setTextSize(paramInt);
      requestLayout();
    } 
    setSwitchTypefaceByIndex(typedArray.getInt(R.styleable.TextAppearance_android_typeface, -1), typedArray.getInt(R.styleable.TextAppearance_android_textStyle, -1));
    if (typedArray.getBoolean(R.styleable.TextAppearance_textAllCaps, false)) {
  ...
  private class ThumbAnimation extends Animation {
    ...
    private ThumbAnimation(float param1Float1, float param1Float2) {
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v7\widget\SwitchCompat.class
