...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  public void setColorSchemeResources(@ColorRes int... paramVarArgs) {
    ...
    for (int i = 0; i < paramVarArgs.length; i++)
      arrayOfInt[i] = resources.getColor(paramVarArgs[i]); 
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\widget\SwipeRefreshLayout.class
