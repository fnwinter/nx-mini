...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild, ScrollingView {
  ...
  public void computeScroll() {
    ...
    if (this.mScroller.computeScrollOffset()) {
      ...
      if (m != n || i != j) {
        k = getScrollRange();
        int i1 = ViewCompat.getOverScrollMode((View)this);
        boolean bool1 = bool;
        if (i1 != 0)
          if (i1 == 1 && k > 0) {
            bool1 = bool;
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent) {
    ...
    switch (i & 0xFF) {
      ...
      case 0:
        ...
        this.mLastMotionY = i;
        this.mActivePointerId = MotionEventCompat.getPointerId((MotionEvent)viewParent, 0);
    ...
    switch (i) {
      ...
      case 2:
        ...
        if (j == -1) {
          ...
          int m = (int)MotionEventCompat.getY(paramMotionEvent, j);
          ...
          if (this.mIsBeingDragged) {
            ...
            int n = getScrollY();
            m = getScrollRange();
            k = ViewCompat.getOverScrollMode((View)this);
            if (k == 0 || (k == 1 && m > 0)) {
              k = 1;
            } else {
              k = 0;
            ...
            if (dispatchNestedScroll(0, i1, 0, i - i1, this.mScrollOffset)) {
              ...
              k = n + i;
              if (k < 0) {
                this.mEdgeGlowTop.onPull(i / getHeight(), MotionEventCompat.getX(paramMotionEvent, j) / getWidth());
                if (!this.mEdgeGlowBottom.isFinished())
                  this.mEdgeGlowBottom.onRelease(); 
              } else if (k > m) {
                this.mEdgeGlowBottom.onPull(i / getHeight(), 1.0F - MotionEventCompat.getX(paramMotionEvent, j) / getWidth());
                if (!this.mEdgeGlowTop.isFinished())
                  this.mEdgeGlowTop.onRelease(); 
              } 
      ...
      case 5:
        ...
        this.mLastMotionY = (int)MotionEventCompat.getY((MotionEvent)velocityTracker, i);
        this.mActivePointerId = MotionEventCompat.getPointerId((MotionEvent)velocityTracker, i);
      case 6:
        break;
    } 
    onSecondaryPointerUp((MotionEvent)velocityTracker);
    this.mLastMotionY = (int)MotionEventCompat.getY((MotionEvent)velocityTracker, MotionEventCompat.findPointerIndex((MotionEvent)velocityTracker, this.mActivePointerId));
  }
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
