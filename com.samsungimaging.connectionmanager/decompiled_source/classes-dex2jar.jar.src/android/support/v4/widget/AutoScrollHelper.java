...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  public AutoScrollHelper(View paramView) {
    ...
    int j = (int)(315.0F * displayMetrics.density + 0.5F);
  ...
  private static class ClampedScroller {
    ...
    private float getValueAt(long param1Long) {
      ...
      return AutoScrollHelper.constrain((float)(param1Long - l) / this.mEffectiveRampDown, 0.0F, 1.0F) * f2 + 1.0F - f1;
    }
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\widget\AutoScrollHelper.class
