      ...
      if (i != 1) {
        if (i == 2) {
          ...
          if ("root-path".equals(str2)) {
            file = buildPath(DEVICE_ROOT, new String[] { str3 });
          } else if ("files-path".equals(str2)) {
            file = buildPath(paramContext.getFilesDir(), new String[] { str3 });
          } else if ("cache-path".equals(str2)) {
            file = buildPath(paramContext.getCacheDir(), new String[] { str3 });
          } else if ("external-path".equals(str2)) {
            file = buildPath(Environment.getExternalStorageDirectory(), new String[] { str3 });
          } 
          if (file != null)
            simplePathStrategy.addRoot(str1, file); 
        } 
        continue;
      } 
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\content\FileProvider.class
