...
class NotificationCompatJellybean {
  ...
  public static NotificationCompatBase.Action getAction(Notification paramNotification, int paramInt, NotificationCompatBase.Action.Factory paramFactory, RemoteInputCompatBase.RemoteInput.Factory paramFactory1) {
    synchronized (sActionsLock) {
      Bundle bundle1;
      Object object = getActionObjectsLocked(paramNotification)[paramInt];
  ...
  private static Bundle getBundleForAction(NotificationCompatBase.Action paramAction) {
    ...
    bundle.putInt("icon", paramAction.getIcon());
    bundle.putCharSequence("title", paramAction.getTitle());
    bundle.putParcelable("actionIntent", (Parcelable)paramAction.getActionIntent());
    bundle.putBundle("extras", paramAction.getExtras());
    bundle.putParcelableArray("remoteInputs", (Parcelable[])RemoteInputCompatJellybean.toBundleArray(paramAction.getRemoteInputs()));
    return bundle;
  }
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\app\NotificationCompatJellybean.class
