...
public class ListFragment extends Fragment {
  ...
  private void setListShown(boolean paramBoolean1, boolean paramBoolean2) {
    ...
    if (paramBoolean1) {
      if (paramBoolean2) {
        this.mProgressContainer.startAnimation(AnimationUtils.loadAnimation((Context)getActivity(), 17432577));
        this.mListContainer.startAnimation(AnimationUtils.loadAnimation((Context)getActivity(), 17432576));
      } else {
    ...
    if (paramBoolean2) {
      this.mProgressContainer.startAnimation(AnimationUtils.loadAnimation((Context)getActivity(), 17432576));
      this.mListContainer.startAnimation(AnimationUtils.loadAnimation((Context)getActivity(), 17432577));
    } else {
      this.mProgressContainer.clearAnimation();
      this.mListContainer.clearAnimation();
    } 
  ...
  public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup, Bundle paramBundle) {
    ...
    FrameLayout frameLayout1 = new FrameLayout((Context)fragmentActivity);
    LinearLayout linearLayout = new LinearLayout((Context)fragmentActivity);
    linearLayout.setId(16711682);
    linearLayout.setOrientation(1);
    linearLayout.setVisibility(8);
    linearLayout.setGravity(17);
    linearLayout.addView((View)new ProgressBar((Context)fragmentActivity, null, 16842874), (ViewGroup.LayoutParams)new FrameLayout.LayoutParams(-2, -2));
    frameLayout1.addView((View)linearLayout, (ViewGroup.LayoutParams)new FrameLayout.LayoutParams(-1, -1));
    FrameLayout frameLayout2 = new FrameLayout((Context)fragmentActivity);
    ...
    ListView listView = new ListView((Context)getActivity());
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\app\ListFragment.class
