...
class DrawableCompatBase {
  ...
  public static Drawable wrapForTinting(Drawable paramDrawable) {
    ...
    if (!(paramDrawable instanceof DrawableWrapperDonut))
      drawable = new DrawableWrapperDonut(paramDrawable); 
    return drawable;
  }
}


/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\graphics\drawable\DrawableCompatBase.class
