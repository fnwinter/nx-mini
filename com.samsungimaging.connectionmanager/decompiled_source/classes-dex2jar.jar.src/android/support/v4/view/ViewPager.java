...
public class ViewPager extends ViewGroup {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent) {
    ...
    //   81: sipush #255
    //   84: iand
    //   85: tableswitch default -> 128, 0 -> 143, 1 -> 411, 2 -> 205, 3 -> 541, 4 -> 132, 5 -> 572, 6 -> 605
    //   128: iload #10
    //   130: istore #9
    //   132: iload #9
    //   134: ifeq -> 141
    ...
    //   190: aload_1
    //   191: iconst_0
    //   192: invokestatic getPointerId : (Landroid/view/MotionEvent;I)I
    ...
    //   217: invokestatic findPointerIndex : (Landroid/view/MotionEvent;I)I
    //   220: istore #6
    //   222: iload #6
    //   224: iconst_m1
    //   225: if_icmpne -> 237
    ...
    //   237: aload_1
    //   238: iload #6
    //   240: invokestatic getX : (Landroid/view/MotionEvent;I)F
    //   243: fstore_2
    //   244: fload_2
    //   245: aload_0
    ...
    //   255: aload_1
    //   256: iload #6
    //   258: invokestatic getY : (Landroid/view/MotionEvent;I)F
    //   261: fstore_3
    //   262: fload_3
    //   263: aload_0
    ...
    //   334: aload_0
    //   335: iconst_1
    //   336: invokespecial setScrollState : (I)V
    //   339: aload_0
    //   340: iconst_1
    ...
    //   382: invokestatic findPointerIndex : (Landroid/view/MotionEvent;I)I
    //   385: invokestatic getX : (Landroid/view/MotionEvent;I)F
    ...
    //   510: invokestatic findPointerIndex : (Landroid/view/MotionEvent;I)I
    //   513: invokestatic getX : (Landroid/view/MotionEvent;I)F
    //   516: aload_0
    ...
    //   543: istore #9
    //   545: aload_0
    //   546: getfield mIsBeingDragged : Z
    //   549: ifeq -> 132
    //   552: aload_0
    //   553: aload_0
    //   554: getfield mCurItem : I
    //   557: iconst_1
    //   558: iconst_0
    //   559: iconst_0
    //   560: invokespecial scrollToItem : (IZIZ)V
    //   563: aload_0
    //   564: invokespecial resetTouch : ()Z
    //   567: istore #9
    //   569: goto -> 132
    //   572: aload_1
    //   573: invokestatic getActionIndex : (Landroid/view/MotionEvent;)I
    //   576: istore #6
    //   578: aload_0
    //   579: aload_1
    //   580: iload #6
    //   582: invokestatic getX : (Landroid/view/MotionEvent;I)F
    //   585: putfield mLastMotionX : F
    //   588: aload_0
    //   589: aload_1
    //   590: iload #6
    //   592: invokestatic getPointerId : (Landroid/view/MotionEvent;I)I
    //   595: putfield mActivePointerId : I
    //   598: iload #10
    //   600: istore #9
    //   602: goto -> 132
    //   605: aload_0
    //   606: aload_1
    //   607: invokespecial onSecondaryPointerUp : (Landroid/view/MotionEvent;)V
    //   610: aload_0
    //   611: aload_1
    //   612: aload_1
    //   613: aload_0
    //   614: getfield mActivePointerId : I
    //   617: invokestatic findPointerIndex : (Landroid/view/MotionEvent;I)I
    //   620: invokestatic getX : (Landroid/view/MotionEvent;I)F
    //   623: putfield mLastMotionX : F
    //   626: iload #10
    //   628: istore #9
    //   630: goto -> 132
  }
  ...
  void populate(int paramInt) {
    ...
    if (getWindowToken() != null) {
      ...
      int n = Math.max(0, this.mCurItem - paramInt);
      ...
      if (k != this.mExpectedAdapterCount) {
        ...
        throw new IllegalStateException("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: " + this.mExpectedAdapterCount + ", found: " + k + " Pager id: " + str + " Pager class: " + getClass() + " Problematic adapter: " + this.mAdapter.getClass());
      } 
      ...
      while (true) {
        ...
        if (itemInfo1 != null) {
          ...
          if (i4 <= 0) {
            ...
            f1 = 2.0F - itemInfo1.widthFactor + getPaddingLeft() / i4;
          } 
          ...
          while (true) {
              ...
              if (object >= f1) {
                if (i2 < n) {
                  ...
                  if (itemInfo3 != null && i2 == itemInfo3.position) {
                    f3 = object + itemInfo3.widthFactor;
                    i = i3 - 1;
                    if (i >= 0) {
                      itemInfo2 = this.mItems.get(i);
                    } else {
                    ...
                    f3 = object + (addNewItem(i2, i3 + 1)).widthFactor;
                    paramInt = i1 + 1;
                    if (i3 >= 0) {
                      itemInfo2 = this.mItems.get(i3);
                    } else {
            ...
            if (f4 < 2.0F) {
              ...
              while (true) {
                if (i < k)
                  if (f4 >= f1 && i > m) {
                    if (itemInfo3 != null) {
                      ...
                      itemInfo2 = itemInfo3;
                      paramInt = i2;
                      if (i == itemInfo3.position) {
                        f3 = f4;
                        itemInfo2 = itemInfo3;
                        paramInt = i2;
                        if (!itemInfo3.scrolling) {
                          this.mItems.remove(i2);
                          this.mAdapter.destroyItem(this, i, itemInfo3.object);
                          if (i2 < this.mItems.size()) {
                            itemInfo2 = this.mItems.get(i2);
                            paramInt = i2;
                            f3 = f4;
                    ...
                    if (itemInfo3 != null && i == itemInfo3.position) {
                ...
                if (itemInfo1 != null) {
                  Object object1 = itemInfo1.object;
                } else {
                  itemInfo2 = null;
                } 
                  ...
                  if (view == null || ((ItemInfo)view).position != this.mCurItem) {
                    ...
                    while (true) {
                      if (paramInt < getChildCount()) {
                        ...
                        ItemInfo itemInfo4 = infoForChild(view);
                        if (itemInfo4 == null || itemInfo4.position != this.mCurItem || !view.requestFocus(j)) {
                          paramInt++;
                          continue;
                        } 
                      } 
...
/* Location:              C:\Users\fnwin\source\dev\nx-mini\com.samsungimaging.connectionmanager\classes-dex2jar.jar!\android\support\v4\view\ViewPager.class
